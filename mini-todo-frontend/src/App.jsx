...
function App() {
  ...
  const fetchTasks = () => {
    axios.get("http://65.2.78.79:3000/tasks")
  ...
  const addTask = () => {
    ...
    axios.post("http://65.2.78.79:3000/tasks", { task })
      .then(res => {
  ...
  const toggleComplete = (t) => {
    axios.patch(`http://65.2.78.79:3000/tasks/${t.id}`, {
  ...
  const removeTask = (id) => {
    axios.delete(`http://65.2.78.79:3000/tasks/${id}`)
